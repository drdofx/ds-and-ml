...
for key in leagues:
    ...
    df.to_csv(f"../../dataset/loan_player_data/DataCSV_{leagues[key]}_2021.csv", encoding='utf-8-sig', index=None)
    df.to_excel(f"../../dataset/loan_player_data/DataXLSX_{leagues[key]}_2021.xlsx", sheet_name='Data', encoding='utf-8-sig')
    row, column = df.shape
